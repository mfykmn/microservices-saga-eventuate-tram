...
dependencies {
    ...
    implementation("io.eventuate.tram.sagas:eventuate-tram-sagas-spring-orchestration-simple-dsl:0.13.0.RELEASE")
//    implementation("io.eventuate.tram.sagas:eventuate-jpa-sagas-framework:0.13.0.RELEASE")
    implementation("io.eventuate.tram.core:eventuate-tram-jdbc-kafka:0.13.0.RELEASE")
    // Spring Boot
